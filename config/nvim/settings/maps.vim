...
"print current date
autocmd FileType markdown nnoremap <leader>d i# BBB <Esc>:put =strftime('%a %d %b %Y')<CR>i<Backspace><Esc>A<CR><CR><++><CR><Esc>/BBB<CR>"_cw
...
autocmd BufWinEnter 2021.md nnoremap <leader>d i# BBB <Esc>:put =strftime('%a %d %b %Y')<CR>i<Backspace><Esc>A<CR><CR>Dear journal, <CR><CR><++><Esc>/BBB<CR>"_cw
